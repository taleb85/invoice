...
export type Translations = {
  ...
  fatture: {
    ...
    refreshFornitoreReassignedFromDocSuccess: string
    contextMenuOpenAttachment: string
    contextMenuOpenDetail: string
  ...
  fornitori: {
    ...
    confermeOrdineOcrAutoProgress: string
  ...
  log: {
    ...
    inboxAiSupplierMismatchWarning: string
    inboxAiBillingPlatformSenderHint: string
