...
import { analyzeOrdineDuplicatesForDeletion, type OrdineDupListRow } from '@/lib/check-duplicates'
...
describe('analyzeOrdineDuplicatesForDeletion (conferme)', () => {
  ...
  it('marks same numeric order number without date as excess', () => {
    const a = analyzeOrdineDuplicatesForDeletion([
