...
- **nota_credito** — credit note, note de crédit, Gutschrift, Avoir: a document issued by the seller that reduces a prior invoice amount. Classify as nota_credito (not fattura) even if the layout is similar to an invoice.
