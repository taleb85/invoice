...
export const ACTIVITY_ACTIONS = {
  ...
  FORNITORE_MERGED: 'fornitore.merged',
  DUPLICATE_BULK_DELETED: 'duplicate.bulk_deleted',
  FATTURA_DUPLICATE_CLEANUP: 'fattura.duplicate_cleanup',
...
const LABEL_MAP: Record<ActivityAction, string> = {
  ...
  [ACTIVITY_ACTIONS.FORNITORE_MERGED]: 'Fornitori uniti',
  [ACTIVITY_ACTIONS.DUPLICATE_BULK_DELETED]: 'Duplicati eliminati',
  [ACTIVITY_ACTIONS.FATTURA_DUPLICATE_CLEANUP]: 'Pulizia fatture duplicate',
