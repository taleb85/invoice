...
const it: Translations = {
  ...
  fornitori: {
    ...
    supplierMonthlyDocHint:
      'Mesi dell’anno fiscale della sede dall’inizio dell’esercizio fino al mese evidenziato in alto (stesso criterio del sync email). Clic su una riga per impostare quel mese.',
