...
const it: Translations = {
  ...
  dashboard: {
    ...
    adminPortalGlobalNavHint:
      'Senza sede attiva: Approvazioni, Attività, Email log e Backup restano nel menu e coprono tutta la rete. Per analytics, fornitori e vista operativa sede scegli una filiale nel menu Sedi o «Vista operativa» su una card.',
