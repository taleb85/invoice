...
type Translations = {
  ...
  dashboard: {
    ...
    /** Dashboard Aurora: fascia grafico andamento mensile */
    homeMonthlyTrendTitle: string
    homeMonthlyTrendCompareAnalytics: string
    homeMonthlyTrendExportDemo: string
    homeMonthlyTrendExportDemoAria: string
    homeChartLegendSpend: string
    homeChartLegendBolle: string
    homeChartLegendFatture: string
    homeEmptyMonthlyTrend: string
    homeSmartPairTitle: string
    /** `{pct}` = percentuale intera */
    homeSmartPairMatchedLine: string
    homeRiskSynthTitle: string
    homeRiskLow: string
    homeRiskMedium: string
    homeRiskHigh: string
    homePrioritiesTitle: string
    homePriorityDupInvoices: string
    homePriorityDupBolle: string
    homePriorityRevision: string
    homePriorityStatements: string
    /** Segnaposto `{n}` */
    homePrioritySubtitleWithCount: string
    homePriorityAllClearSubtitle: string
...
const it: Translations = {
  ...
  dashboard: {
    ...
    homeMonthlyTrendTitle: 'Andamento mensile',
    homeMonthlyTrendCompareAnalytics: 'Bolle vs fatture · Analitiche',
    homeMonthlyTrendExportDemo: 'Esporta (anteprima)',
    homeMonthlyTrendExportDemoAria: 'Esportazione non ancora disponibile — anteprima UI',
    homeChartLegendSpend: 'Importo fatturato',
    homeChartLegendBolle: 'Bolle',
    homeChartLegendFatture: 'Fatture',
    homeEmptyMonthlyTrend: 'Nessun documento nell’anno fiscale selezionato fin qui.',
    homeSmartPairTitle: 'Smart pair scanner · Score anomalie',
    homeSmartPairMatchedLine: '{pct}% bolle ricomposte',
    homeRiskSynthTitle: 'Risk score sintetico',
    homeRiskLow: 'BASSO',
    homeRiskMedium: 'MEDIO',
    homeRiskHigh: 'ALTO',
    homePrioritiesTitle: 'Priorità',
    homePriorityDupInvoices: 'Gruppi fatture duplicate',
    homePriorityDupBolle: 'Bolle sovrapposte',
    homePriorityRevision: 'Coda revisione',
    homePriorityStatements: 'Estratti conto · verifiche',
    homePrioritySubtitleWithCount: '{n} da sistemare · apri ora',
    homePriorityAllClearSubtitle: 'Binario aggiornato',
