...
const it: Translations = {
  ...
  impostazioni: {
    ...
    linkSollecitiDrawerCollapsedHint: 'Clicca per aprire il collegamento.',
    linkSollecitiDrawerAriaOpen: 'Espandi il collegamento ai solleciti automatici',
    linkSollecitiDrawerAriaClose: 'Comprimi il collegamento ai solleciti automatici',
