...
type Translations = {
  ...
  fornitori: {
    ...
    /** Profilo Rekki: apre popup browser. Senza ID: ricerca Google `site:rekki.com` + nome. */
    rekkiOpenInApp: string
    /** Titolo pannello slide-over Rekki / ricerca. */
    rekkiEmbedPanelTitle: string
    /** Segnaposto `{name}` = ragione sociale. */
    rekkiSheetIntro: string
    rekkiGoToListinoButton: string
    rekkiEmbedProbeHint: string
  ...
  appStrings: {
    ...
    /** Desktop scheda fornitore — popover selettore periodo (mese/anno KPI). */
    ...
    listinoForceUpdateFromDocButton: string
    listinoForceUpdateFromDocWorking: string
    /** `{n}` = righe inserite */
    listinoForceUpdateFromDocDone: string
    listinoForceUpdateFromDocError: string
...
const it: Translations = {
  ...
  fornitori: {
    ...
    rekkiOpenInApp: 'Apri su Rekki',
    rekkiEmbedPanelTitle: 'Rekki',
    rekkiSheetIntro: 'Stai aprendo il listino di {name}.',
    rekkiGoToListinoButton: 'VAI AL LISTINO',
    rekkiEmbedProbeHint:
      'Anteprima interna (spesso vuota per limiti del sito): usa il pulsante sopra per aprire una finestra dedicata 800×900.',
    ...
    rekkiGuidedPasteHint:
      'Si apre Google con ricerca su rekki.com. Apri il profilo fornitore, copia l’URL dalla barra indirizzi, incollalo nel campo ID: lo slug viene estratto subito; poi Salva per attivare il confronto prezzi.',
    rekkiIdUrlNotParsed:
      'Il campo ID contiene un URL Rekki non riconosciuto. Incolla l’URL completo del profilo nel campo ID oppure solo lo slug fornitore.',
    saving: 'Salvataggio...',
  ...
  appStrings: {
    ...
    supplierDesktopPeriodPickerTitle: 'Periodo (mese)',
    supplierDesktopPeriodPickerButtonAria: 'Apri il calendario per scegliere il mese del periodo',
    ...
    listinoImportSaveBlockedHintOperator:
      'Alcune righe selezionate hanno data documento anteriore al listino: deselezionale o chiedi a un amministratore.',
    ...
    listinoForceUpdateFromDocButton: 'Forza aggiornamento listino',
    listinoForceUpdateFromDocWorking: 'Aggiornamento…',
    listinoForceUpdateFromDocDone: 'Listino aggiornato ({n} righe).',
    listinoForceUpdateFromDocError: 'Impossibile aggiornare il listino.',
...
const en: Translations = {
  ...
  common: { save: 'Save', cancel: 'Cancel', delete: 'Delete', edit: 'Edit', new: 'New', loading: 'Loading...', error: 'Error', success: 'Success', noData: 'No data', document: 'Document', actions: 'Actions', date: 'Date', status: 'Status', supplier: 'Supplier', notes: 'Notes', phone: 'Phone', saving: 'Saving...', attachment: 'Attachment', openAttachment: 'Open attachment', detail: 'Detail', add: 'Add', rename: 'Rename', role: 'Role', aiExtracted: 'AI Extracted Data', matched: 'Matched', notMatched: 'Not matched', recordSupplierLinked: 'Linked', company: 'Company', invoiceNum: 'Invoice No.', total: 'Total', duplicateBadge: 'DUPLICATE' },
  ...
  appStrings: {
    ...
    supplierDesktopPeriodPickerTitle: 'Period (month)',
    supplierDesktopPeriodPickerButtonAria: 'Open calendar to choose the billing month',
    addingAlias: 'Adding…',
    ...
    listinoImportSaveBlockedHintOperator:
      'Some selected rows have a document date older than the listino: deselect them or ask an administrator.',
    listinoDocDetailImportHint:
    ...
    listinoForceUpdateFromDocButton: 'Force listino update',
    listinoForceUpdateFromDocWorking: 'Updating…',
    listinoForceUpdateFromDocDone: 'Listino updated ({n} rows).',
    listinoForceUpdateFromDocError: 'Could not update the listino.',
...
const es: Translations = {
  ...
  fatture: { title: 'Facturas', new: 'Nueva Factura', noInvoices: 'Sin facturas.', addFirst: 'Añadir la primera →', invoice: 'Factura', openBill: 'Abrir albarán →', deleteConfirm: '¿Eliminar esta factura? La operación es irreversible.', countLabel: 'facturas recibidas', headerBolla: 'Albarán', headerAllegato: 'Adjunto', apri: 'Abrir →', caricaFatturaTitle: 'Subir Factura', bollaMarkata: 'El albarán se marcará como completado', collegataABolla: 'Vinculada a un albarán', bollaPasseraCompletato: 'Al guardar el albarán pasará a "completado"', dataFattura: 'Fecha Factura', fileFattura: 'Archivo Factura', caricaPdfFoto: 'Subir PDF o tomar foto', maxSize: 'PDF, JPG, PNG, WebP — máx 10 MB', savingInProgress: 'Guardando...', salvaChiudiBolla: 'Guardar y Cerrar Albarán', dettaglio: 'Detalle', bollaCollegata: 'Albarán vinculado', statusAssociata: 'Asociada', statusSenzaBolla: 'Sin albarán', colNumFattura: 'N.º Factura', nessunaFatturaRegistrata: 'Sin facturas registradas', duplicateInvoiceSameSupplierDateNumber: 'Esta factura ya está registrada: mismo proveedor, misma fecha y mismo número de documento. Para sustituir el PDF, abre la factura existente y usa «Sustituir adjunto».', duplicateInvoiceSameSupplierDateAmountNoNumber: 'Esta factura ya está registrada: mismo proveedor y fecha, mismo importe y sin número de documento en archivo. Para sustituir el PDF, abre la factura existente y usa «Sustituir adjunto».', duplicateDeleteConfirm: '¿Eliminar esta copia de la factura {numero}? Se conservará el original.', duplicateRemoveCopy: 'Eliminar duplicado', duplicateRemoveThisCopy: 'Quitar esta copia', duplicatePairBadgeAria: 'Resaltar el par de facturas duplicadas', },
  ...
  appStrings: {
    ...
    supplierDesktopPeriodPickerTitle: 'Periodo (mes)',
    supplierDesktopPeriodPickerButtonAria: 'Abrir calendario para elegir el mes del periodo',
    ...
    listinoImportSaveBlockedHintOperator:
      'Algunas filas tienen fecha anterior al listino: desmárcalas o pide a un administrador.',
    listinoDocDetailImportHint:
    ...
    listinoForceUpdateFromDocButton: 'Forzar listino',
    listinoForceUpdateFromDocWorking: 'Actualizando…',
    listinoForceUpdateFromDocDone: 'Listino actualizado ({n} filas).',
    listinoForceUpdateFromDocError: 'No se pudo actualizar el listino.',
...
const fr: Translations = {
  ...
  appStrings: {
    ...
    supplierDesktopPeriodPickerTitle: 'Période (mois)',
    supplierDesktopPeriodPickerButtonAria: 'Ouvrir le calendrier pour choisir le mois de la période',
    addingAlias: 'Ajout…',
    ...
    listinoImportSaveBlockedHintOperator:
      'Certaines lignes ont une date antérieure au listino : désélectionnez-les ou demandez un admin.',
    listinoDocDetailImportHint:
    ...
    listinoForceUpdateFromDocButton: 'Forcer le listino',
    listinoForceUpdateFromDocWorking: 'Mise à jour…',
    listinoForceUpdateFromDocDone: 'Listino mis à jour ({n} lignes).',
    listinoForceUpdateFromDocError: 'Impossible de mettre à jour le listino.',
...
const de: Translations = {
  ...
  appStrings: {
    ...
    supplierDesktopPeriodPickerTitle: 'Zeitraum (Monat)',
    supplierDesktopPeriodPickerButtonAria: 'Kalender öffnen, um den Monat des Zeitraums zu wählen',
    ...
    listinoImportSaveBlockedHintOperator:
      'Einige Zeilen haben ein älteres Belegdatum als das Listino — abwählen oder Admin fragen.',
    listinoDocDetailImportHint:
    ...
    listinoForceUpdateFromDocButton: 'Listino erzwingen',
    listinoForceUpdateFromDocWorking: 'Wird aktualisiert…',
    listinoForceUpdateFromDocDone: 'Listino aktualisiert ({n} Zeilen).',
    listinoForceUpdateFromDocError: 'Listino konnte nicht aktualisiert werden.',
