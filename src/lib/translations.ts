...
const it: Translations = {
  ...
  strumentiCentroOperazioni: {
    ...
    pageSubtitle:
      'Sincronizzazione email (24 ore e anno precedente), ripassaggio batch documenti, duplicati, correzione date OCR e abbinamenti. Le preferenze fisse (localizzazione, IMAP completo dalla scheda sede, solleciti, notifiche, nomi OCR, regole di scarto, approvazioni) stanno in Impostazioni.',
  ...
  dashboard: {
    ...
    adminGlobalSubtitle:
      'Panoramica sedi e stato tecnico (posta, log di sincronizzazione, OCR). Nessun dato commerciale aggregato tra filiali.',
    adminGlobalTotalsLabel: 'Totali rete',
    adminPortalGlobalNavHint:
      'Nel menu laterale globale: riepilogo sedi, Consumi AI e backup. Per analitiche, approvazioni, attività e log email usa «Vista operativa» su una filiale.',
    ...
    adminGlobalConsoleSubtitle:
      'Errori tecnici per filiale (ultime 72h): sincronizzazione email e posta IMAP. Nessun dato commerciale.',
    adminGlobalConsoleEmpty: 'Nessun evento tecnico registrato nel periodo.',
    adminGlobalConsoleOpenLog: 'Apri log completo →',
    adminGlobalConsoleAria: 'Console eventi tecnici per filiale',
    ...
    adminGlobalConsoleUnknownSede: 'Sede non associata',
  ...
  impostazioni: {
    ...
    imapBranchSessionTitle: 'Sede (contesto attivo)',
    sedeScopedAdminHint:
      'Per email IMAP, nomi OCR, regole di scarto e approvazioni fatture serve una sede attiva: usa Gestione sedi, scegli la sede dal menu in alto oppure entra come operatore (PIN).',
    sedeScopedConfigLoadErr: 'Impossibile caricare i dati OCR della sede.',
    approvalSectionTitle: 'Approvazione fatture',
    approvalSectionSubtitle: 'Configura la soglia per l’approvazione manuale',
    sedeDocsGroupingEyebrow: 'Documenti & OCR della sede',
  ...
  log: {
    ...
    inboxGeminiHistorySubtitle:
      'Salvato solo sul browser di questo dispositivo (circa gli ultimi 35 cicli per sede): per ogni «Analizza con AI» vedi nome file, tipo suggerito, confidenza e cosa è successo dopo (scarto automatico, registrazione, ancora in coda). Nessuna sincronizzazione con altri PC.',
    ...
    inboxGeminiHistoryClear: 'Svuota cronologia (questa sede)',
  ...
  appStrings: {
    ...
    approvazioni_masterNetworkHint:
      'Come admin master vedi le richieste di tutte le sedi (in elenco fino a 100, ordinate per importo). La filiale è indicata su ogni riga.',
    analyticsPageSub: 'Panoramica acquisti e riconciliazione',
    analyticsRequireSedeTitle: 'Seleziona una filiale',
    analyticsRequireSedeHint:
      'Le analitiche sono disponibili solo per una sede alla volta. Torna al riepilogo globale e apri «Vista operativa» sulla filiale che ti interessa.',
