...
const it: Translations = {
  ...
  dashboard: {
    ...
    adminPortalGlobalNavHint:
      'Qui vedi solo anagrafica sedi e segnalazioni tecniche. Per fornitori, bolle e fatture apri «Vista operativa» o il menu Sedi. Approvazioni, Attività, Email log e Backup restano disponibili per tutta la rete.',
