...
type Translations = {
  ...
  dashboard: {
    ...
    /** Callout dashboard globale: molte voci di menu richiedono una sede selezionata */
    adminPortalGlobalNavHint: string
    ...
    /** Console operativa portale globale */
    adminGlobalConsoleTitle: string
    adminGlobalConsoleSubtitle: string
    adminGlobalConsoleEmpty: string
    adminGlobalConsoleOpenLog: string
    adminGlobalConsoleAria: string
    adminGlobalConsoleChannelImap: string
    adminGlobalConsoleStatoSupplier: string
    adminGlobalConsoleStatoBolla: string
    adminGlobalConsoleAttachment: string
    adminGlobalConsoleUnknownSede: string
    adminGlobalConsoleTimeUnknown: string
...
const it: Translations = {
  ...
  dashboard: {
    ...
    adminPortalGlobalNavHint:
      "Nel menu laterale globale: riepilogo aziende, Consumi AI e backup. Per analitiche, approvazioni, attività e log email usa «Vista operativa» su un'azienda.",
    ...
    adminGlobalConsoleTitle: 'Console operativa',
    adminGlobalConsoleSubtitle:
      'Errori tecnici per azienda (ultime 72h): sincronizzazione email e posta IMAP. Nessun dato commerciale.',
    adminGlobalConsoleEmpty: 'Nessun evento tecnico registrato nel periodo.',
    adminGlobalConsoleOpenLog: 'Apri log completo →',
    adminGlobalConsoleAria: 'Console eventi tecnici per azienda',
    adminGlobalConsoleChannelImap: 'IMAP',
    adminGlobalConsoleStatoSupplier: 'Fornitore',
    adminGlobalConsoleStatoBolla: 'Bolla',
    adminGlobalConsoleAttachment: 'Allegato',
    adminGlobalConsoleUnknownSede: 'Azienda non associata',
    adminGlobalConsoleTimeUnknown: '—',
  ...
  sedi: {
    ...
    fileRetentionSectionHint: 'Per i documenti oltre l’età scelta puoi rimuovere gli allegati dallo storage mantenendo importi, date e fornitori nel database. Il job mensile automatico non è ancora collegato: servono script o cron lato server.',
    fileRetentionPolicyLabel: 'Cosa fare con gli allegati vecchi',
    ...
    fileRetentionMonthsLabel: 'Rimuovi allegati più vecchi di (mesi, dalla data documento)',
  ...
  appStrings: {
    ...
    sedeWizardStepOf: 'Passo {step} di 4',
...
const en: Translations = {
  ...
  appStrings: {
    ...
    sedeWizardStepOf: 'Step {step} of 4',
    sedeWizardNext: 'Next',
    sedeWizardBack: '← Back',
    sedeWizardSkip: 'Skip',
...
const es: Translations = {
  ...
  appStrings: {
    ...
    sedeWizardStepOf: 'Paso {step} de 4',
...
const fr: Translations = {
  ...
  appStrings: {
    ...
    sedeWizardStepOf: 'Étape {step} sur 4',
...
const de: Translations = {
  ...
  appStrings: {
    ...
    sedeWizardStepOf: 'Schritt {step} von 4',
