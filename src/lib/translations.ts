...
const it: Translations = {
  ...
  fornitori: {
    ...
    listinoNoDataHint: 'Inserisci i prezzi direttamente nella tabella <code class="font-mono text-slate-200">listino_prezzi</code> su Supabase.',
    ...
    supplierMonthlyDocTitle: 'Riepilogo documenti per mese',
    ...
    supplierMonthlyDocFiscalSelected: 'Anno fiscale (sede) per il mese in evidenza: {year}',
