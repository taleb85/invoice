...
const it: Translations = {
  ...
  dashboard: {
    ...
    adminPortalGlobalNavHint:
      'Analytics, approvazioni, elenco fornitori, registro email e backup dipendono dalla sede selezionata: scegli una filiale nel menu Sedi o «Vista operativa» su una card.',
