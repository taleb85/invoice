...
const it: Translations = {
  ...
  dashboard: {
    ...
    adminGlobalSubtitle:
      'Sedi e impostazioni: qui non compaiono volumi di acquisti o fatture tra filiali. Apri «Vista operativa» su una card per i dati operativi.',
    adminGlobalTotalsLabel: 'Totali rete',
    adminPortalGlobalNavHint:
      'Senza sede attiva il portale non mostra numeri operativi aggregati sulle filiali. Usa «Vista operativa» o il menu Sedi. Approvazioni, Attività, Email log e Backup restano disponibili per tutta la rete.',
