...
type Translations = {
  ...
  sedi: {
    ...
    /** Elenco operatori in sola lettura sulla scheda sede — creazione / PIN altrove */
...
const it: Translations = {
  ...
  sedi: {
    ...
    operatorsRosterReadOnlyHint:
      'L’elenco sopra è solo informativo (nome e ruolo). Per aggiungere qualcuno usa il form qui sotto. Per cambiare il PIN di un operatore già creato usa la funzione «Cambia PIN» da Strumenti → Gestione sedi / operatori (o dove il tuo ruolo la espone).',
