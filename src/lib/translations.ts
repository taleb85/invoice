...
type Translations = {
  ...
  log: {
    ...
    /** Coda elaborazione documenti dalla posta (AI Inbox) */
...
const it: Translations = {
  ...
  log: {
    ...
    activityProcessDocumentsCta: 'Elabora in AI Inbox',
  },
  sedi: {
    title: 'Sede e Utenti',
