...
const es: Translations = {
  ...
  impostazioni: { title: 'Configuración', subtitle: 'Personalizar moneda y zona horaria', lingua: 'Idioma', valuta: 'Moneda', fuso: 'Zona horaria', preview: 'Vista previa', saved: 'Configuración guardada — actualizando…', sectionLocalisation: 'Localización', accountSection: 'Cuenta', changeSede: 'Cambiar sede', addOperatorsPickSede: 'Elige la sede activa en Sedes — luego podrás crear operadores (nombre + PIN) aquí.', imapSection: 'Email IMAP', linkSolleciti: 'Recordatorios automáticos', linkSollecitiDesc: 'Días de espera y avisos a proveedores' },
  sollecitiSettingsPage: {
    title: 'Recordatorios',
