        ...
        {headerMenuOpen && stackedHeaderTrigger && headerMenuRect != null && typeof document !== 'undefined'
          ? createPortal(
              <div
                ...
                className="rounded-lg border-t-2 border-t-sky-400/55 border-x-0 border-b-0 app-workspace-surface-elevated p-3 shadow-[0_16px_48px_-12px_rgba(0,0,0,0.65)] backdrop-blur-md"
              >
                {headerMenuInner}
              </div>,
              document.body,
