...
import GmailSetupModal from '@/components/GmailSetupModal'
...
export default function GmailAuditReadyBadge({ fornitoreNome }: GmailAuditReadyBadgeProps) {
  ...
  return (
    <>
      <div className="mb-5 rounded-xl bg-gradient-to-br from-cyan-500/10 via-blue-500/10 to-purple-500/10 p-4 shadow-lg ring-1 ring-inset ring-cyan-500/30 backdrop-blur-sm">
