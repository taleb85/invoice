              ...
              <>
                ...
                <div className="flex justify-end">
                  <button
                    ...
                    className="flex items-center gap-2 rounded-lg border-t-2 border-t-[#22d3ee] border-x-0 border-b-0 bg-white/[0.04] px-4 py-2 text-sm font-medium text-app-fg transition-colors hover:bg-app-line-10"
                  >
