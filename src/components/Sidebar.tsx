          ...
          {footerOpen && (
            <div className="mt-1.5 space-y-0.5 border-t border-app-line-18 pt-1.5">
              ...
              <Link
                ...
                className={`flex w-full items-center gap-2 rounded-md px-2 py-1 text-xs font-semibold transition-colors ${pathname === '/strumenti/impostazioni' ? 'text-app-fg bg-app-line-10' : 'text-app-fg-subtle hover:bg-app-line-10 hover:text-app-fg'}`}
              >
