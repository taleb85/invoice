...
const innerCls =
  'flex w-full min-w-0 flex-col gap-3 px-3 py-2 sm:flex-row sm:flex-nowrap sm:items-center sm:gap-x-4 sm:px-4 sm:py-2.5 md:items-center md:gap-x-5 md:px-6 md:py-2.5 lg:gap-x-7 lg:px-8 xl:px-10'
