...
function SupplierCardSkeleton() {
  return (
    <div className="relative flex h-full flex-col overflow-hidden rounded-2xl border border-sky-500/15 bg-app-line-10/40 sm:rounded-3xl">
      ...
      {/* Footer */}
      <div className="mt-auto h-10 w-full animate-pulse rounded-b-2xl border-t border-sky-500/10 bg-app-line-10/60 sm:rounded-b-3xl" />
    </div>
  )
}
...
export default function FornitoriLoading() {
  return (
    <div className={APP_SHELL_SECTION_PAGE_STACK_CLASS}>
      ...
      {/* KPI summary card */}
      <div className="h-16 w-full animate-pulse rounded-xl border border-sky-500/20 bg-sky-500/8" />

      {/* Search bar */}
      <div className="h-10 w-full animate-pulse rounded-lg border border-sky-500/20 bg-app-line-10/50" />
