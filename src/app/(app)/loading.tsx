    ...
    <div className="flex flex-1 flex-col gap-6 p-4 animate-pulse md:p-8">
      ...
      <div className="flex items-center justify-between">
        <div className="space-y-2">
          ...
          <div className="hidden h-4 w-56 rounded-lg bg-slate-700/80 md:block" />
        </div>
      ...
      <div className="app-card overflow-hidden">
        ...
        <div className="h-12 border-b border-slate-700/60 bg-slate-700/40" />
        {Array.from({ length: 6 }).map((_, i) => (
          <div
            key={i}
            className="flex items-center gap-4 border-b border-slate-600/80/80 px-6 py-4 last:border-0"
          >
            <div className="h-9 w-9 shrink-0 rounded-full bg-slate-700/80" />
