...
const COLOR_MAP: Record<string, { bg: string; text: string; border: string; dot: string; chip: string }> = {
  blue:   { bg: 'bg-transparent',   text: 'text-blue-200',   border: 'border-blue-400/30',   dot: 'bg-blue-500',   chip: 'border border-blue-400/35 bg-transparent text-blue-200' },
  cyan:   { bg: 'bg-transparent',   text: 'text-app-fg-subtle',   border: 'border-app-line-30',   dot: 'bg-app-cyan-500',   chip: 'border border-app-line-30 bg-transparent text-app-fg-subtle' },
  green:  { bg: 'bg-transparent',  text: 'text-emerald-200',  border: 'border-emerald-400/30',  dot: 'bg-emerald-500',  chip: 'border border-emerald-400/35 bg-transparent text-emerald-200' },
  purple: { bg: 'bg-transparent', text: 'text-purple-200', border: 'border-purple-400/30', dot: 'bg-purple-500', chip: 'border border-purple-400/35 bg-transparent text-purple-200' },
  orange: { bg: 'bg-transparent', text: 'text-orange-200', border: 'border-orange-400/30', dot: 'bg-orange-500', chip: 'border border-orange-400/35 bg-transparent text-orange-200' },
  amber:  { bg: 'bg-transparent',  text: 'text-amber-200',  border: 'border-amber-400/30',  dot: 'bg-amber-500',  chip: 'border border-amber-400/35 bg-transparent text-amber-200' },
  slate:  { bg: 'bg-transparent',  text: 'text-app-fg',  border: 'border-app-line-25',  dot: 'bg-white/40',  chip: 'border border-app-line-28 bg-transparent text-app-fg-subtle' },
}
                ...
                <div className="px-5 py-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      {item.tip && (
                        <div className="mt-2.5 flex items-start gap-2 rounded-lg border border-amber-400/35 bg-transparent px-3 py-2">
