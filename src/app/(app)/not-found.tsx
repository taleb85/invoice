...
export default async function AppNotFound() {
  ...
  const secondary =
    'inline-flex flex-1 min-w-[8rem] items-center justify-center gap-2 rounded-xl border border-app-line-35 app-workspace-inset-bg-soft px-4 py-2.5 text-sm font-medium text-app-fg-muted transition-colors hover:border-app-a-45 hover:bg-app-line-10 hover:text-app-fg'
