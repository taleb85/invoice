      ...
      <div className="w-full max-w-md space-y-6 text-center">
        ...
        <div className="app-card-login flex flex-col overflow-hidden">
          ...
          <div className="flex flex-col gap-2.5 pt-1 sm:flex-row sm:flex-wrap">
            <Link
              href="/"
              className="inline-flex flex-1 min-w-[8rem] items-center justify-center gap-2 rounded-xl bg-cyan-500 px-4 py-2.5 text-sm font-medium text-white transition-colors hover:bg-cyan-600"
            >
