    ...
    <div className="flex-1 flex items-center justify-center p-4 min-h-[60vh]">
      <div className="w-full max-w-md text-center space-y-6">
        ...
        <div className="app-card overflow-hidden text-left">
          ...
          {error.digest && (
            <p className="rounded-lg border border-slate-700/60 bg-slate-950/40 px-3 py-1.5 font-mono text-[11px] text-slate-400">
          ...
          <div className="flex flex-col sm:flex-row gap-2.5 pt-1">
            ...
            <Link
              href="/"
              className="flex-1 inline-flex items-center justify-center gap-2 rounded-xl border border-slate-600/80 bg-slate-800/80 px-4 py-2.5 text-sm font-medium text-slate-200 transition-colors hover:bg-slate-800"
            >
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
