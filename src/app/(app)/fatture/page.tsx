  ...
  return (
    <div className={APP_SHELL_SECTION_PAGE_STACK_FILL_CLASS}>
      ...
      {!sedeId && !isMasterAdmin ? (
        <div className="shrink-0 rounded-xl border border-[rgba(34,211,238,0.15)] bg-amber-950/25 px-4 py-3 text-sm text-amber-100">
          {t.dashboard.operatorNoSede}
        </div>
      ) : null}

      <div className={APP_SHELL_SECTION_PAGE_BODY_FILL_CLASS}>
        {fatture.length === 0 ? (
