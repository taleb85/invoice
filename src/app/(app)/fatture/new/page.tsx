    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <form onSubmit={handleSubmit} className="flex-1 flex flex-col gap-4 p-4 max-w-lg mx-auto w-full">
        ...
        <button
          ...
          className="w-full py-4 bg-accent hover:bg-accent-hover active:bg-cyan-700 disabled:opacity-50 text-white text-base font-semibold rounded-2xl transition-colors mt-auto shadow-sm flex items-center justify-center gap-2"
        >
          {saving ? (
            <>
