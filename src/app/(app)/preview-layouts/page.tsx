...
function MockSidebar({ active }: { active: string }) {
  ...
  const navLink = (isActive: boolean) =>
    `flex items-center gap-2.5 px-2.5 py-2 rounded-lg text-xs font-medium transition-all whitespace-nowrap border-l-2 pl-[9px] ${
      isActive
        ? 'bg-app-line-15 text-white border-app-cyan-500'
        : 'text-app-fg-muted hover:bg-app-line-12 hover:text-app-fg border-transparent'
    }`

  const suppliers = ['Amalfi Produce London', 'Oral-B UK']

  return (
    <aside className="w-52 app-workspace-surface-elevated flex flex-col flex-shrink-0 min-h-full shadow-[4px_0_32px_rgba(0,0,0,0.45)]">
      {/* Logo */}
      <div className="border-b border-app-line-25 px-3 py-2.5">
        ...
        <div>
          ...
          >
            <span className="flex items-center gap-2.5 min-w-0">
              ...
              <span className="shrink-0 rounded-full border border-app-line-25 app-workspace-inset-bg px-1.5 py-0.5 text-[10px] font-medium text-app-fg-muted">2</span>
            </span>
          ...
          {fornitoriOpen && (
            <div className="ml-3.5 mt-0.5 space-y-0.5 border-l border-app-line-28 pl-2.5">
              {/* Tutti i fornitori */}
              <a href="#" className="flex items-center gap-2 px-2 py-1.5 rounded-md text-[11px] font-medium text-app-fg-muted hover:bg-app-line-12 hover:text-app-fg-muted transition-colors">
              ...
              {suppliers.map((s, i) => (
                <a key={s} href="#" className={`flex items-center gap-2 px-2 py-1.5 rounded-md text-[11px] font-medium transition-colors ${i === 0 && active === 'suppliers' ? 'bg-app-line-15 text-white' : 'text-app-fg-muted hover:bg-app-line-12 hover:text-app-fg'}`}>
                  <span className={`w-1 h-1 rounded-full shrink-0 ${i === 0 && active === 'suppliers' ? 'bg-app-cyan-400' : 'bg-current opacity-50'}`} />
      ...
      <div className="px-3 pb-2">
        <div className="flex items-center gap-2 rounded-xl border border-app-line-22 app-workspace-inset-bg-soft px-2.5 py-2">
          <div className="w-6 h-6 rounded-full bg-app-line-20 flex items-center justify-center text-[10px] font-bold text-app-fg-muted shrink-0">S</div>
          <div className="flex-1 min-w-0">
            <p className="text-[10px] text-app-fg-muted leading-none mb-0.5 uppercase tracking-wide font-semibold">Operatore</p>
            <p className="text-[11px] text-app-fg-muted truncate font-medium leading-none">Staff Mediterran…</p>
          </div>
          <button className="p-1 text-app-fg-muted hover:text-app-cyan-500 rounded-md transition-colors shrink-0">
      ...
      {/* Footer */}
      <div className="border-t border-app-line-28 px-3 py-3 space-y-1">
        {/* Language */}
        <button className="w-full flex items-center gap-2 px-2.5 py-1.5 text-app-fg-muted hover:text-app-fg-muted hover:bg-app-line-12 rounded-lg transition-colors text-[11px]">
        ...
        {/* Nuova Bolla */}
        <a href="#" className="flex items-center justify-center gap-1.5 w-full px-3 py-2 bg-app-cyan-500 hover:bg-cyan-600 text-white text-xs font-semibold rounded-lg transition-colors shadow-[0_0_12px_rgba(6,182,212,0.25)]">
          <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {/* Settings */}
        <a href="#" className="flex items-center gap-2.5 w-full px-2.5 py-2 text-app-fg-muted hover:text-app-fg hover:bg-app-line-12 text-xs font-medium rounded-lg transition-colors border-l-2 border-transparent pl-[9px]">
          <svg className="w-4 h-4 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {/* Logout */}
        <button className="flex items-center gap-2.5 w-full px-2.5 py-2 text-app-fg-muted hover:text-app-fg hover:bg-app-line-15 text-xs font-medium rounded-lg transition-colors">
          <svg className="w-4 h-4 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
