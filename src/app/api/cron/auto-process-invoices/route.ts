...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    logger.info(`[AUTO-REINFER] ${reinferResult.processed} processati, ${reinferResult.matched} match, ${reinferResult.dateFixed} date corrette, ${reinferResult.typeFixed} tipi corretti, ${reinferResult.ghostEmailsRemoved} email fantasma rimosse, ${reinferResult.ordineAutoFinalized} ordini finalizzati`)
